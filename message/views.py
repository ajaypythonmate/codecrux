    ...
    if resp.status_code != 201:
        ...
        if resp.status_code != 201:
            ...
            payload = {
                ...
                # "WebLocation": "https://kodecrux-django.herokuapp.com/password-email-verification/?email="+email,
                "WebLocation": "https://kodecrux-django.herokuapp.com/password-email-verification/?email=" + email,
    ...
    if resp.status_code != 201:
        ...
        if resp.status_code != 201:
            ...
            payload = {
                ...
                # "WebLocation": "https://kodecrux-django.herokuapp.com/teamtemplate/?email="+email,
                "WebLocation": "https://kodecrux-django.herokuapp.com/teamtemplate/?email=" + email,
...
class TeamviewerMeetingtokenView(APIView):
    ...
    def get(self, request, format=None):
        ...
        if resp.status_code != 201:
            ...
            r = requests.get('https://kodecrux-django.herokuapp.com/teamtemplate/')
            print ('r',r)
