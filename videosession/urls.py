...
urlpatterns = [
    ...
    path('currentuser/', customuser_views.CurrentUserView.as_view(),
         name='currentuser'),
    ...
    path('facebookuser/', customuser_views.FacebookUserView.as_view(),
         name='facebookuser'),
    path('api-token-auth/', views.obtain_auth_token),
    path('conversationcreate/', message_views.ConversationView.as_view(),
         name='conversationview'),
    path('password-email-verification/', customuser_views.ForgotPasswordEmailVerificationViewSet.as_view(),
         name='ForgotPasswordEmailVerificationViewSet'),
    path('password-email/', customuser_views.ForgotPasswordEmailSecondVerificationViewSet.as_view(),
         name='ForgotPasswordEmailSecondVerificationViewSet'),
    path('api/auth/oauth/', include('rest_framework_social_oauth2.urls')),
    path('hello/', customuser_views.HelloView.as_view(), name='hello'),
    path('google/', customuser_views.GoogleView.as_view(),
         name='google'),  # add path for google authentication
    path('eduser/', user_views.EducatorView.as_view(), name='eduser'),
    path('user/', customuser_views.UserView.as_view(), name='user'),
    path('cForgotPasswordViewsetode/',
         customuser_views.OTP.as_view(), name='code'),
    path('refresh/', message_views.refresh_token, name='home'),
    path('order/', Order.as_view(), name="hired"),
    # path('order-successful/',
    #      SuccessfulOrder.as_view(), name="hired"),
    path('teamviewer/', message_views.TeamviewerView.as_view(), name='teamviewer'),
    path('teamviewer-access/',
         message_views.TeamviewerAccesstokenView.as_view(), name='teamviewer'),
    #    path('teamviewer-refresh/', message_views.TeamviewerRefreshAccesstokenView.as_view(), name='teamviewer-refresh'),
    path('teamviewer-meeting/', message_views.TeamviewerMeetingtokenView.as_view(),
         name='teamviewer-meeting'),
