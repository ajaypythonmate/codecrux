...
class CustomUserSerializers(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id','username','pincode','state','city','otp','password','email','first_name','last_name','phone','is_instructor','is_freelancer','is_codeexpert','is_client','technology','sub_technology','topic','last_seen','total_experience','relevant_experience','profile_pic',)
